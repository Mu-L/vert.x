...
To enable decompression set {@link io.vertx.core.http.CompressionConfig#setDecompressionEnabled(boolean)} on the
...
To enable compression use can configure it with {@link io.vertx.core.http.CompressionConfig#setCompressionEnabled}.
...
The minimum response content size threshold for compression can be configured via {@link io.vertx.core.http.CompressionConfig#setContentSizeThreshold}.
